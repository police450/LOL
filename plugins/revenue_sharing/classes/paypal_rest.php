...
class revPaypalRest 
{
	...
	var $requests = array(
		...
		"pp_payout" => "/payments/payouts?sync_mode=true"
	...
	function __construct(){
		...
		global $Cbucket;
		$rev_config = $Cbucket->configs;
		
		$this->initilzed = true;
		if($rev_config['rev_test_mode']=='enabled'){
			$this->devMode();
		}
 	...
 	/**
	* Used set development mode for paypal api
	* @author  : Fahad Abbas
	*/
	...
	*/
	...
	/**
	* Used to hit paypal api
	* @param   : { Array }
	* @return  : { Paypal reponse } 
	* @since   : 13th April, 2017 ClipBucket 2.8.2
	* @author  : Fahad Abbas
	*/

...
class Upload{
	...
	*/
	function loadLocationFields($default=NULL)
	{
		...
		$bcountry = $default['blocked_countries'];
		...
		(
		 'blocked_countries'=> array('title'=>lang('Blocked in countries'),
							'type'=> 'dropdown',
							'name'=> 'blockedcountries',
							'id'=> 'blockedcountries',
							'value'=> $country_array,
							'checked'=> $bcountry,
							'db_field'=>'blocked_countries',
							'required'=>'no',
							'default_value'=>'',
							),
		 'country'=> array('title'=>lang('Uploaded from'),
							'type'=> 'dropdown',
							'name'=> 'country',
							'id'=> 'country',
							'value'=> $country_array,

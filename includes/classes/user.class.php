...
class userquery extends CBCategory{
	...
	function userquery()
	{
        ...
        $basic_fields = array(
            ...
            'subscribers','total_subscriptions','is_live','is_verified'
        );
	...
	*/
	...
	function action($case,$uid)
	{
		...
		switch($case)
		{
			...
			case "vf":
			{
				$db->update($tbl,array('is_verified'),array('yes')," userid='$uid' ");
			...
			case "uv":
			{
				$db->update($tbl,array('is_verified'),array('no')," userid='$uid' ");
				e(lang("User has been removed from verified users"),'m');
			}
			break;
...
function getSubscriptionsUploadsWeek($uid,$limit=20,$uploadsType="both",$uploadsTimeSpan="this_week")
{
	...
	function load_personal_details($default)
	{
		...
		'twitter_url' => array(
						  ...
						  'name'=> "twitter_url",
						  'id'=> "twitter_url",
						  'value'=> $default['twitter_url'],
						  'db_field'=>'twitter_url',
						  'auto_view'=>'yes',
						  'display_function'=>'outgoing_link'
						  ),
		'insta_url' => array(

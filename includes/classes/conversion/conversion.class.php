		...
		*/
		...
		function __construct( $ffmpegParams ) {
			...
			$this->ffmpegConfigs = array(
				...
				'videoBitrate_240'=> config( 'vbrate_240' ),
				'videoBitrate_360'=> config( 'vbrate_360' ),
				'videoBitrate_480'=> config( 'vbrate_480' ),
				'videoBitrate_720'=> config( 'vbrate_720' ),
				'videoBitrate_1080'=> config( 'vbrate_1080' ),

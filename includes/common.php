...
*/
	...
	//Forcing to www if there is www in baseurl
	$current_url = $pages->GetCurrentUrl();
	if(strstr($baseurl, 'www.') && !strstr($current_url, 'www.')) {
		$baseurl = str_replace(array("https://www.","http://www.","www."), "", $baseurl);
		$baseurl = '//www.'.$baseurl;
	...
	define("USER_BG_URL",BASEURL.'/images/backgrounds');
 	...
 	define('VBRATE_240', $row['vbrate_240']);
 	define('VBRATE_360', $row['vbrate_360']);
 	define('VBRATE_480', $row['vbrate_480']);
 	define('VBRATE_720', $row['vbrate_720']);
 	define('VBRATE_1080', $row['vbrate_1080']);
	...
	//cb_register_function('check_cb_license','clipbucket_init_completed');
